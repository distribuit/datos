...
public class RamFileSystem extends AbstractFileSystem implements Serializable
{
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileSystem#createFile(com.datos.vfs.FileName)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileSystem#addCapabilities(java.util.Collection)
     */
    @Override
