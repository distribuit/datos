 ...
 */
package com.datos.vfs.provider.webdav;
...
import com.datos.vfs.impl.DefaultFileSystemManager;
import com.datos.vfs.provider.http.HttpFileProvider;
import org.apache.commons.httpclient.HttpClient;
import com.datos.vfs.provider.GenericFileName;
import com.datos.vfs.provider.http.HttpClientFactory;
...
public class WebdavFileProvider
     ...
     * {@link FileObject FileObject} in the FileSystem, then be sure
     * to use correct signature of the {@link FileSystemManager FileSystemManager}
     * resolveFile method.
     *
     * @see DefaultFileSystemManager#resolveFile(FileObject, String, FileSystemOptions)
     */
    @Override
