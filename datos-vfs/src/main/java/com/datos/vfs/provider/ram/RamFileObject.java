...
public class RamFileObject extends AbstractFileObject<RamFileSystem>
{
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doGetType()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doListChildren()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doGetContentSize()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doGetInputStream()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doGetOutputStream(boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doDelete()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doGetLastModifiedTime()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doSetLastModifiedTime(long)
     */
    /** @since 2.0 */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doCreateFolder()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doRename(com.datos.vfs.FileObject)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doGetRandomAccessContent(
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#doAttach()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#injectType(com.datos.vfs.FileType)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.provider.AbstractFileObject#endOutput()
     */
    @Override
