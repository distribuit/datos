...
public final class CryptorFactory
{
     ...
     */
    public static final String CRYPTOR_CLASS = "com.datos.vfs.cryptor";
     ...
     * can be set by setting the "com.datos.vfs.cryptor" System property to the
