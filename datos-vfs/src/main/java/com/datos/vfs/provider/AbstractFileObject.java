...
import com.datos.vfs.operations.DefaultFileOperations;
import com.datos.vfs.operations.FileOperations;
...
public abstract class AbstractFileObject<AFS extends AbstractFileSystem> implements FileObject
{
    ...
    public InputStream getInputStream() throws FileSystemException
    {
        ...
        */
        ...
        catch (final com.datos.vfs.FileNotFoundException exc)
        {
            throw new com.datos.vfs.FileNotFoundException(fileName, exc);
        }
