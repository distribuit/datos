...
public class RamFileRandomAccessContent implements RandomAccessContent
{
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.RandomAccessContent#getFilePointer()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.RandomAccessContent#seek(long)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.RandomAccessContent#length()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.datos.vfs.RandomAccessContent#close()
     */
    @Override
    public void close() throws IOException
    {
